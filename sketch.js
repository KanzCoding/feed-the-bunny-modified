...
function preload()
{
  ...
  blower2 = loadImage("balloon2.png")
...
function setup() {
  ...
  blink.frameDelay = 20;
  eat.frameDelay = 20;
  bunny = createSprite(425,245,100,100);
  bunny.addImage(rabbit);
  bunny.scale = 0.2;
  higherground =new Ground(300+100+25,170+100+45,100,10);
  theRoof = new Ground(250,10,width,20)
...
function airBlow ()
{
  ...
  //just this is the force which going to apllied to the fruit 
